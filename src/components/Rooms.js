   ...
   function navi(){
    ...
    return(
      ...
      <Carousel.Item style={{ width:'100%', height:'100%'}}>
        <img src={ele.image1} style={{ width:'100%' , height:'800px'}} />
        <Carousel.Caption  >
...
<div className="s1" style={{ display:"flex", justifyContent:"space-between",width:"95%"}}>
    {/* <div  className='p-4'style={{display:"flex"}}>
    <i class="fa-solid fa-bed-pulse mt-1"></i>
    <p>Beds:1</p>
    </div> */}
    <div  className="p-4 s2"style={{display:"flex",}}>
