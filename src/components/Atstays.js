      ...
      <div style={{ display: 'flex' }}>
        <div className="container-fluid">
          <div className="row">
            ...
            <div className='mt-4'>  <button className="btn btn-md  mt-3 openn p-2" style={{width:'50%', float:'right',backgroundColor:'#66cccc' ,marginRight:'50px' , display:'none' }} onClick={clickhere}>Filter</button>            </div>
